...
god: ./build/src/end.o ./build/src/life.o ./build/src/mas.o ./build/src/Goddess_bless.o 
	g++ -std=c++17 -Wall -Werror $(DIR) -o ./bin/god -DSFML_STATIC -ID:\LABA\Note\SFML\include -LD:\LABA\Note\SFML\lib -lsfml-graphics-s -lsfml-window-s -lsfml-system-s -lsfml-audio-s -lopengl32 -lwinmm -lgdi32 -lfreetype 
